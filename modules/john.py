...
class JohnToolView(QWidget):
    ...
    def _build_custom_ui(self):
        ...
        format_label = QLabel("Hash Format")
        format_label.setStyleSheet(f"color: {COLOR_TEXT_PRIMARY}; font-weight: 500;")
        ...
        # Wordlist selection (for wordlist mode)
        wordlist_label = QLabel("Wordlist (for Dictionary Attack)")
